...
import {AuthorizationDashboardComponent} from "@modules/admin/authorization/dashboard/authorization-dashboard.component";
import {PanelMenuModule} from "primeng/panelmenu";
import {SplitterModule} from "primeng/splitter";
import {NgForOf} from "@angular/common";
import {ToggleButtonModule} from "primeng/togglebutton";
import {
  RolePermissionsViewComponent
} from "@modules/admin/authorization/components/role-permissions-view/role-permissions-view.component";
import {SelectButtonModule} from "primeng/selectbutton";
import {ListboxModule} from "primeng/listbox";

@NgModule({
  declarations: [AuthorizationDashboardComponent, RolePermissionsViewComponent],
  exports: [AuthorizationDashboardComponent, RolePermissionsViewComponent],
  imports: [
    CardModule,
    PanelMenuModule,
    PrimeTemplate,
